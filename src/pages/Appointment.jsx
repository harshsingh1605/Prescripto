...
const getAvailableSlots = async () => {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    if (today.getDate() === currentDate.getDate()) {
      ...
      currentDate.setHours(currentDate.getHours() > 10 ? 10 : currentDate.getHours() + 1);
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4' >
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='flex items-center gap-2 text-2xl font-semibold tex-gray-900'>
            {docInfo.name}
            <img className='w-5' src={assets.verified_icon} alt="" />
          </p>
          <div className='flex items-center gap-2 text-sm mt-1 tex-gray-600'>
      ...
      {/* -------------- Appointment Slots ------------ */}
<div className="sm:mt-4 sm:pl-4 mt-4 font-medium text-gray-700">
  <p>Booking slots</p>
  <div className="flex gap-3 items-center w-full overflow-x-scroll mt-4">
    {docSlots && docSlots.length > 0 ? (
      ...
      <p className="text-gray-500">No booking slots available</p>
    )}
  </div>
